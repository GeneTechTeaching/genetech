...
mRNA moleculas can then diffuse freely from the cells and a fraction of these molecules 
...
of unique genes. So why do certain reagions have higher number of unique genes? As so
...
# visible and also use add.alpha = T to further increase background visibility
...
FeatureOverlay(se.HER2, features = "seurat_clusters", pt.size = 1.5, pt.alpha = 0.5) &
...
FeatureOverlay(se.HER2, features = de.markers.one$gene, ncols = 3, pt.size = 1, pt.alpha = 0.5, show.sb = F)
...
Such factors can be learnt from the data, but also defined _a priori_; a good
