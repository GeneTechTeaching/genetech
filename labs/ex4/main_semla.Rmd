...
p2 <- MapLabels(se.HER2, column_name = "orig.ident", pt_size = 1) &
  theme(legend.title = element_blank(),
        legend.position = "none",
        plot.subtitle = element_blank())
p2 <- ModifyPatchworkTitles(p, titles = c("Semla's plotting")) 
...
We can see that the global minimum of the bottom function is achieved at x = 22, 
so the model has determined that 22 factors can describe the variability of our dataset.
...
Factor 21 looks kinda interesting, almost as if it's surrounding the DCIS
...
print(sprintf("Factor 21 is associated with process %d", ans.q11))
