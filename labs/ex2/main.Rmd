...
>
> 1.  What is the type of the elements in `counts`?
>
> 2.  What dimensions does the data in `counts` have? Answer should be a vector containing two elements i.e. the number of rows and columns respectively.
>
...
To obtain the normalized counts you can run `counts(dds, normalized = T)`.
